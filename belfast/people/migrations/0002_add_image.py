...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProfilePicture.image'
        db.add_column(u'people_profilepicture', 'image',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=01, related_name='profilepicture_set', to=orm['django_image_tools.Image']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProfilePicture.image'
        db.delete_column(u'people_profilepicture', 'image_id')
